...
-- Time-sync
local sync_types = {
	{ time = 6, weather = "EXTRASUNNY", name = "Morning" },
	{ time = 8, weather = "EXTRASUNNY", name = "Morning" },
	{ time = 10, weather = "EXTRASUNNY", name = "Morning" },
	{ time = 12, weather = "EXTRASUNNY", name = "Afternoon" },
	{ time = 14, weather = "EXTRASUNNY", name = "Afternoon" },
	{ time = 16, weather = "EXTRASUNNY", name = "Afternoon" },
	{ time = 18, weather = "EXTRASUNNY", name = "Evening" },
	{ time = 20, weather = "EXTRASUNNY", name = "Evening" },
}
