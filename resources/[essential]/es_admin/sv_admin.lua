...
TriggerEvent("es:addGroup", "mod", "police", function(group) end)

-- Default commands

--TriggerEvent('es:addGroupCommand', 'car', "admins" function(source, args, user)
...
TriggerEvent('es:addGroupCommand', 'noclip', "admin", function(source, args, user)
	...
	TriggerClientEvent('chatMessage', source, "", {255, 0, 0}, "You are not an ^1admin^7.")
end)
...
TriggerEvent('es:addGroupCommand', 'kick', "mod", function(source, args, user)
		if(GetPlayerName(tonumber(args[2])))then
			...
			TriggerEvent("es:getPlayerFromId", player, function(target)
				...
				TriggerClientEvent('chatMessage', -1, "", {255, 0, 0}, "Player ^4" .. GetPlayerName(player) .. "^0 has been kicked(^2" .. reason .. "^0)")
				DropPlayer(player, reason)
			end)
		else
			TriggerClientEvent('chatMessage', source, "", {255, 0, 0}, "Incorrect ^4player ^7ID!")
		end
end, function(source, args, user)
...
TriggerEvent('es:addGroupCommand', 'ban', "admin", function(source, args, user)
		if(GetPlayerName(tonumber(args[2])) ~= nil)then
			...
			TriggerEvent("es:getPlayerFromId", player, function(target)
				...
				TriggerClientEvent('chatMessage', -1, "Server", {255, 0, 0}, "Player 42" .. GetPlayerName(player) .. "^0 has been banned(^1" .. reason .. "^0)")
