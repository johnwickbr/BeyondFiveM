...
AddEventHandler('printEmoteList', function()
	TriggerEvent('chatMessage', "", {255, 0, 0}, "^4Emotes^7: crossarms, sit, chair, kneel, medic, notepad, traffic, photo, clipboard, lean, handsup(Hold X)");
end)

AddEventHandler('printInvalidEmote', function()
	TriggerEvent('chatMessage', "", {255, 0, 0}, "Emote does not ^1exist^7 , use /emotes for a list");
end)
